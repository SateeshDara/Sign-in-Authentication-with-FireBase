...
class LoginController: UIViewController,GIDSignInUIDelegate {
    ...
    lazy var loginRegisterButton: RegisterButton = {
        let button = RegisterButton (type: .system)
        button.backgroundColor = UIColor(r: 100, g: 50, b: 100)
    ...
    let nameSeparatorView: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor.black//UIColor(r: 220, g: 220, b: 220)
        view.translatesAutoresizingMaskIntoConstraints = false
        return view
    }()
    ...
    // Google Sign
        ...
        googleButton.frame = CGRect(x: 12, y: 570, width: view.frame.width-26, height: 50)
        ...
        button.addTarget(self, action: #selector(anImportantUserAction), for: .touchUpInside)
        button.sizeToFit()
